<?php 
    // QUERY: Ambil data transaksi penjualan (Header)
    $sql = "SELECT * FROM penjualan ORDER BY tanggal DESC, idjual DESC";
...
<div class="user-management no-print">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold text-light">Laporan Penjualan (Rekap Nota)</h3>
        <div>
    ...
    <div class="table-responsive mt-3">
        <table class="table table-dark table-striped table-hover align-middle rounded-3 overflow-hidden">
            ...
            <tbody class="text-center">
                <?php if (!empty($data_penjualan)): $no = 1; $total_omset = 0; foreach ($data_penjualan as $row): 
                ...
                <?php else: ?>
                    <tr><td colspan="5" class="py-4">Belum ada data transaksi.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
...
<div id="print-area">
    ...
    <table class="table-print">
        ...
        <tbody>
            <?php if (!empty($data_penjualan)): $no = 1; $total_omset_print = 0; foreach ($data_penjualan as $row): 
            ...
            <?php endforeach; ?>
                <tr>
                    <td colspan="3" style="text-align: right; font-weight: bold; padding-right: 15px; border: 1px solid black;">TOTAL OMSET :</td>
